...
const About = () => {
    return (
        <>
            <div id="about" className="flex flex-col items-center h-screen bg-gray-200 p-6 ">
                ...
                <div className="flex justify-center items-center w-4/5  gap-x-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-150  text-center">
                        ...
                        <div className="flex justify-center gap-6 mt-4">
                            <Icon icon={angularIcon} className="text-red-600" width="40" height="40" />
            ...
            <div className = "bg-black relative top-[-120px] ">
